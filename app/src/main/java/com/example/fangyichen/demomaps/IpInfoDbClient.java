...
public class IpInfoDbClient {
    ...
    public static final String APIKEY = "dee24fe3321cadb3f2325cc302c461bfdf09deccd637340e2742a8cceeb58906"; //my own api key
    public static final String MODE = "ip-city";    //mode set as ip-city
    static {
